  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-gray-900 border border-gray-200 bg-background hover:bg-gray-50 hover:border-gray-300",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline px-0",
        brandBlue: "bg-brandBlue-500 text-white hover:bg-brandBlue-600",
      },
      size: {
        default: "h-10 px-11 py-2",
        sm: "h-12 px-3 text-xs",
        lg: "h-14 px-3 text-xl md:px-20",
        xl: "h-16 md:h-12 px-3 text-sm md:text-md px-11",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
