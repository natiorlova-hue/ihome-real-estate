        ...
        <div className="container">
          <div className="flex items-center gap-6 h-16 md:h-20">
            <Link href={`/${locale}`} className={styles.logo}>
              ...
              <span className="text-base xl:text-xl">{"IHome ∙ Marbella"}</span>
            </Link>
            <div
              className={
                "bg-white fixed transition-all duration-300 w-full max-w-[300px] py-4 " +
                "top-0 left-0 flex flex-col items-center justify-between h-screen " +
                "xl:bg-transparent transition-none xl:grow xl:max-w-none xl:py-0 " +
                `xl:static xl:flex-row xl:h-auto ${
                  isMobileMenuOpen
                    ? "translate-x-0"
